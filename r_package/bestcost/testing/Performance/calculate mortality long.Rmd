...
Calculate the mortality impacts of one crf_id ("PM2.5_premature deaths_all causes_adults_main_ERS-ISEE_2022_selected", 2nd row of df "input_data_mortality") step by step to identify potential bottlenecks.
...
, interval = 0.005,
prof_output = "testing/output/performance/get_popOverTime() whole loop.Rprof")
```
...
, interval = 0.005,
prof_output = "testing/output/performance/move_rows_up() whole loop.Rprof")
=======
...
system.time(bestcost::get_popOverTime_noAP(
  lifetable_wPop = lifetable_withPop[["female"]],
  firstYear_lifetable = firstYear_lifetable,
  year_loopStart = firstYear_lifetable + 1
  )
...
system.time(bestcost::get_popOverTime_noAP_opt(
  lifetable_wPop = lifetable_withPop[["female"]],
  firstYear_lifetable = firstYear_lifetable,
  year_loopStart = firstYear_lifetable + 1
  ))
>>>>>>> 73d14754c47fba014d44d3809a7f79a272dc65c5
```
...
profvis(
    deaths <- 
    bestcost::get_deaths(shifted_popOverTime = shifted_popOverTime,
                                       firstYear_lifetable = firstYear_lifetable,
                                       age_group = age_group,
                                       min_age = min_age,
                                       max_age = max_age,
                                       ...
                                       crf_rescale_method = crf_rescale_method)
    , interval = 0.005,
prof_output = "testing/output/performance/get_deaths() single call.Rprof")#,
        # rerun = TRUE)
...
profvis(
  yll <-
    ...
    , interval = 0.005, 
prof_output = "testing/output/performance/get_yll() single call.Rprof")
```
