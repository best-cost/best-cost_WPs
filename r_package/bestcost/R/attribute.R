...
#' @param approach_multipollutant \code{String} showing the approach that has to be used in assessments with multiple exposures. To choose among: "additive" and "multiplicative".
