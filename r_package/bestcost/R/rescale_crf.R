...
#' @param cf
#' Counterfactual scenario, i.e. minimum cut-off concentration from where the health impact is quantified.
#' @param crf_per
...
#' @export
rescale_crf <-
  function(crf, exp, cf, crf_per, method){
    if(method == "loglinear"){
