...
bestcost_pm_copd_cost_discount_single_value <- 
  healthiar::include_cost(impact = 2E4, 
                          approach_discount = "exponential",
                          corrected_discount_rate = 0.03,
                          time_period = 20,
                          valuation = 1)
check_general(bestcost_pm_copd_cost_discount_single_value$cost_discounted_rounded,
              14877)
...
bestcost_pm_yll_exposure_single_year_lifetable_geluft <-
  healthiar::attribute_yll_from_lifetable(
    ...
    approach_discount = "exponential", #Alternatives: "hyperbolic_harvey_1986" "hyperbolic_mazur_1987",
    corrected_discount_rate = 0)

# View(bestcost_pm_yll_exposure_single_year_lifetable_geluft)
...
bestcost_pm_yll_exposure_single_year_lifetable_geluft_discounted <-
  healthiar::attribute_yll_from_lifetable(
    ...
    info = input_data_mortality$pollutant[2], 
    min_age = if(is.na(input_data_mortality$min_age[2])) NULL else input_data_mortality$min_age[2],
    approach_discount = "hyperbolic_harvey_1986", 
...
```{r YLL lifetable from SINGLE YEAR exposure and 10 year time horizon}

# Now with input data from the Swiss project GeLuft
bestcost_pm_yll_exposure_single_year_lifetable_geluft_with_time_horizon <-
  healthiar::attribute_yll_from_lifetable(
    approach_exposure = "single_year",
    exp_central = input_data_mortality$exp[2], #exp CH 2019
    prop_pop_exp = 1,
...
check_bestcost(result_list_bestcost = bestcost_pm_yll_exposure_single_year_lifetable_geluft_with_time_horizon,
               result_vector_alternative = c(17052,	8955,	25040)) # Results for 10 year time horizon on 2024-12-09
```
