...
bestcost_noise_ihd_expDist <- 
  bestcost::attribute_health(
    ...
    cutoff_lower = min(niph_noise_ihd_input$exposure_mean) - 10,
    cutoff_upper = min(niph_noise_ihd_input$exposure_mean) + 10,
...
# Comparison (same function call but without summary uncertainty)
bestcost_pm_copd_no_summary_uncertainty <- 
  bestcost::attribute_health(
    exp_central = 8.85, 
    exp_lower = airqplus_pm_copd$mean_concentration - 1,
    exp_upper = airqplus_pm_copd$mean_concentration + 1,
...
print("Main estimate: ") ; bestcost_pm_copd_no_summary_uncertainty[["main"]][["impact_rounded"]]
```
