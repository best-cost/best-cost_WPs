...
round(as.numeric(bestcost_pm_copd_with_summary_uncertainty[["detailed"]][["uncertainty"]]), digits = 0)
...
bestcost_noise_ihd_expDist_iteration[["detailed"]][["raw"]] |> filter(erf_ci == "central") |> filter(exp_ci == "central") |> select(geo_id_raw, impact_rounded) 
## Summary uncertainty estimates from include_summary_uncertainty()
as.numeric(bestcost_noise_ihd_expDist_iteration_uncertainty[["detailed"]][["uncertainty"]][["raw"]]$impact_central)
# Results are higher due to difference in PAF of categories 2 & 3

# Check aggregated impact
print("Main estimate: ") ; bestcost_noise_ihd_expDist_iteration[["main"]][["impact_rounded"]]
print("Summary uncertainty estimates (extern uncertainty function): ")
round(as.numeric(bestcost_noise_ihd_expDist_iteration_uncertainty[["detailed"]][["uncertainty"]][["main"]]), digits = 0)
# Results are higher due to difference in PAF of categories 2 & 3
```
