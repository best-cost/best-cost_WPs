...
bestcost_pm_yld_singlebhd  <- 
  healthiar::attribute_yld_from_prevalence(
    exp_central = 8.85, 
    cutoff_central = 5,    
    bhd_central = 25000,
    rr_central = 1.118,
...
```{r Summary uncertainty rr attribute_yld_from_prevalence, eval=FALSE, include=FALSE}
...
comparison_yld_singlebhd_rr_delta <-
  healthiar::compare_yld_from_prevalence(
    approach_comparison = "delta",
    exp_central_1 = 8.85, 
    exp_central_2 = 6,
    cutoff_central = 5,    
