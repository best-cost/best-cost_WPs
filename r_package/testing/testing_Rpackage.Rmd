...
bestcost_pm_deaths_lifetable_airqplus <-
  bestcost::attribute_deaths_lifetable_rr(
    ...
    rr = unlist(airqplus_pm_deaths_yll[["input"]][, c("relative_risk",
                                                      "relative_risk_lower",
                                                      "relative_risk_upper")]),
    erf_increment = 10, 
...
bestcost_pm_deaths_lifetable_geluft <- 
    ...
    exp = input_data_mortality$exp[2], # PM2.5=8.85 exp in CH in 2019
...
bestcost_pm_yll_lifetable_geluft <- 
  bestcost::attribute_yll_lifetable_rr(
      exp = input_data_mortality$exp[2], #exp CH 2019
      prop_pop_exp = 1,
...
bestcost_pm_yll_lifetable_1rr_geluft <- 
    bestcost::attribute_yll_lifetable_rr(
      ...
      rr = unlist(input_data_mortality[2, c("rr_central")]), # Only one relative risk estimate
      erf_increment = 10, 
      erf_shape = "log_linear",
      first_age_pop = 0,
      last_age_pop = 99,
...
check_bestcost(result_list_bestcost = comparison_singlebhd_ar_delta ,
               result_vector_alternative = c(187594)) # Result on 16 May 2024
