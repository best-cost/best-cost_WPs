...
head(yld$yld$impact_rounded)
```


```{r delta comparison}
# Test delta comparison function with fake values
test_delta_singlebhd_rr <-
...
for(i in 2){                           # Use this if you want to evaluate only one RRs
  impact_mortality_raw[[input_data_mortality$year[i]]][[input_data_mortality$rr_id[[i]]]] <-
    ...
    bestcost::attribute_mortality_lifetable_rr(
...
head(impact_mortality_raw$`2019`$`PM2.5_premature deaths_all causes_adults_main_ERS-ISEE_2022_selected`$deaths$impact)
head(impact_mortality_raw$`2019`$`PM2.5_premature deaths_all causes_adults_main_ERS-ISEE_2022_selected`$yll$impact_rounded)
