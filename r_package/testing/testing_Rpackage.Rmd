...
table(airqplus_yll_difference$`2019` == yll_total$population_2019)
print("2020 total YLLs identical:")
table(airqplus_yll_difference$`2020` == yll_total$population_2020)
print("2020 absolute difference in YLLs:")
difference <- abs(airqplus_yll_difference$`2020` - yll_total$population_2020)
print(difference)
```
