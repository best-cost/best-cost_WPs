...
test_baseline <- bestcost_pm_yll_exposure_single_year_lifetable_airqplus[["detailed"]][["interim"]][["pop_baseline_scenario_nest"]][[3]] %>% 
  select(age, contains("population_")) %>% 
  select(-contains("entry"), -population_2019_end)

test_baseline_entry <- bestcost_pm_yll_exposure_single_year_lifetable_airqplus[["detailed"]][["interim"]][["pop_baseline_scenario_nest"]][[3]] %>% 
  select(age, contains("_entry"))

test_impacted <- bestcost_pm_yll_exposure_single_year_lifetable_airqplus[["detailed"]][["interim"]][["pop_impacted_scenario_nest"]][[3]] %>% 
  select(age, contains("population_")) %>% 
  select(-contains("entry"), -population_2019_end)
