...
bestcost_pm_copd <-
  bestcost::attribute_health(
    ...
    exp_upper = airqplus_pm_copd$mean_concentration*2,
    ...
    bhd_lower = airqplus_pm_copd$incidents_per_100_000_per_year/1E5*airqplus_pm_copd$population_at_risk/2,
    bhd_upper = airqplus_pm_copd$incidents_per_100_000_per_year/1E5*airqplus_pm_copd$population_at_risk*2,
