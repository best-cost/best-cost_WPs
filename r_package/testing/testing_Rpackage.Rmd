...
print(paste("YLD", head(yld$yld$impact_rounded)))
print("YLL (not discounted, as comparison) 45165.79 16337.49 30931.30")
...
impact_yll_expDistribution_raw[[input_data_mortality$year[2]]][[input_data_mortality$rr_id[[2]]]] <-
    bestcost::attribute_yll_lifetable_rr(
      ...
      year_of_analysis = 2019, 
      info = input_data_mortality$pollutant[2], 
      min_age = if(is.na(input_data_mortality$min_age[2])) NULL else input_data_mortality$min_age[i],
      max_age = 99)
