...
# Now with input data from the Swiss project GeLuft
system.time(bestcost_pm_yll_lifetable_geluft <- 
  bestcost::attribute_yll_from_lifetable(
...
bestcost_yll <- bestcost_pm_yll_lifetable_airqplus[1, "yll_nest"] %>% 
  unnest(cols = c(yll_nest))
bestcost_premature_deaths <- bestcost_pm_yll_lifetable_airqplus[1, "premature_deaths_nest"] %>% 
  unnest(cols = c(premature_deaths_nest))

# Compare YLL
table(airqplus_yll_difference$`2019` == bestcost_yll$yll)
table(airqplus_premature_deaths_difference$`2019` ==  bestcost_premature_deaths$premature_deaths)
