...
# Assess multiple geographical sections keeping the multiple uncertainties
bestcost_pm_copd_multiple <-
  bestcost::attribute_health_singlebhd_rr(
    exp_central = as.list(runif_with_seed(26, 8.0, 9.0, 1)),
    exp_lower = as.list(runif_with_seed(26, 8.0, 9.0, 1)-0.1),
    exp_upper = as.list(runif_with_seed(26, 8.0, 9.0, 1)+0.1),
    cutoff = 5,   
    bhd_central = as.list(runif_with_seed(26, 25000, 35000, 1)),
    bhd_lower = as.list(runif_with_seed(26, 25000, 35000, 1)),
    bhd_upper = as.list(runif_with_seed(26, 25000, 35000, 1)),
    rr_central = 1.369, 
    rr_lower = 1.124,
    rr_upper = 1.664,
    erf_increment = 10, 
...
bestcost_pm_yld_lifetable_geluft  <- 
  attribute_yld_lifetable_rr(
    ...
    # exp = c(8, 9, 10), # Fake data. Deactivate to test exposure distribution.
    prop_pop_exp = 1,
