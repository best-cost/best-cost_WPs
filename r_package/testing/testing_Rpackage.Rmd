...
get_lifetable_withPopulation <-
  function(lifetable, population, firstYear_lifetable, nonNatural_mortality){
...
for(i in 2){  #1:nrow(input_data_mortality) Activate this if you need multiple crfs
