...
check_bestcost(result_list_bestcost = att_morb_bestcost,
               result_vector_alternative = result_att_morb_airqplus)
...
yld <- attribute_yld_lifetable_rr(
  ...
  rr = unlist(input_data_mortality[2, c("rr_mean", "rr_lowci", "rr_highci")]), # "rr_central", "rr_lower", "rr_upper"
  rr_increment = 10, 
  erf_shape = "log_linear",
