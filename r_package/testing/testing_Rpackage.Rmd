...
# LUYTAX: IDEA ####
# Idea: possibly combine functions and save in {bestcost} in "R" folder. This might also apply for other functions defined in this script?
...
# LUYTAX: ERROR ####
# Do not forget yll
codebook <- unique(bhd_data[, c("outcome_id", "outcome_label_de", "mort_morb")]) %>%  "outcome_label_de"; # ERROR: there doesn't seem to be a column "outcome_label_de". Should "outcome_label_de" be removed from the statement? 
  # Add label for crf
