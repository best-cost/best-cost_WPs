...
```{r Test summary uncertainty rr single exposure attribute_health }
...
print("Main estimate: ") ; bestcost_pm_copd_with_summary_uncertainty[["main"]][["impact_rounded"]]

# With external uncertainty function
bestcost_pm_copd_extern_uncertainty <- healthiar::include_summary_uncertainty(bestcost_pm_copd_with_summary_uncertainty)
...
```{r Test summary uncertainty rr & exposure distribution}
...
print("Summary uncertainty estimates (extern uncertainty function): ")
bestcost_noise_ihd_expDist_iteration_uncertainty[["detailed"]][["uncertainty"]]$central_estimate
bestcost_noise_ihd_expDist_iteration_uncertainty[["detailed"]][["uncertainty"]]$lower_estimate
bestcost_noise_ihd_expDist_iteration_uncertainty[["detailed"]][["uncertainty"]]$upper_estimate

```



```{r Test summary uncertainty rr attribute_yld_from_prevalence }
...
print("Summary uncertainty estimates: ")
bestcost_pm_yld_singlebhd_with_summary_uncertainty[["detailed"]][["uncertainty"]]$central_estimate
bestcost_pm_yld_singlebhd_with_summary_uncertainty[["detailed"]][["uncertainty"]]$lower_estimate
bestcost_pm_yld_singlebhd_with_summary_uncertainty[["detailed"]][["uncertainty"]]$upper_estimate
print("Main estimate: ") ; bestcost_pm_yld_singlebhd_with_summary_uncertainty[["main"]][["impact_rounded"]]
```

```{r Test summary uncertainty ar}
...
```{r Test summary uncertainty lifetable premature deaths}
