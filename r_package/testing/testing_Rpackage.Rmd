...
att_pm_copd_bestcost <-
  bestcost::attribute_health_singlebhd_rr(
    ...
    rr = c(airqplus_copd$relative_risk, airqplus_copd$relative_risk_lower, airqplus_copd$relative_risk_upper),
    rr_increment = 10, 
...
check_bestcost(result_list_bestcost = att_noise_ihd_bestcost,
...
check_bestcost(result_list_bestcost = att_noise_ha_bestcost,
