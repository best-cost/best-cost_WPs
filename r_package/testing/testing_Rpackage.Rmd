...
# Results are higher due to difference in PAF of geo units 2 & 3
...
## The PAF from the attribute call of geo unit 2 (0.0800) doesn't match with the one obtained in the example_road_noise_niph_test.xlsx, while the PAF for geo unit 2 of the include_summary_uncertainty call does
...
# Aggregated results are higher due to difference in PAF of geo units 2 & 3
```
...
# Main result seems too low (it is only around half of the attribute result). 
