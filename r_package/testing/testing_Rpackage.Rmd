...
#   filter(year == 2020) %>%  select(impact) %>%  as_vector() %>%  unname(.)
...
# PIF
# GIVES ERROR: "object 'rr_conc' not found", ALTHOUGH IT IS THERE ####
## THE SAME FUNCTION IS CALLED ABOVE AND RUNS WITHOUT ERROR
