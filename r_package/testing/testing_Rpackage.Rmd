...
check_bestcost(result_list_bestcost = bestcost_pm_yld_singlebhd_incidence_based ,
               result_vector_alternative = c(5254, 2773 ,7679)) # Result on 29 November 2024

# NOTE 2 December 2024: due to rounding, the impacts with the incidence-based 
# approach are not exactly 10 times higher (because duration is 10 times higher)
#  as those using prevalence approach
```
...
round(as.numeric(bestcost_pm_copd_with_summary_uncertainty[["detailed"]][["uncertainty"]][["intern"]]), digits = 0)
...
round(as.numeric(bestcost_pm_copd_extern_uncertainty[["detailed"]][["uncertainty"]][["main"]]), digits = 0)
...
print("Summary uncertainty estimates (extern uncertainty function): ")
round(as.numeric(bestcost_pm_copd_geo_short_uncertainty[["detailed"]][["uncertainty"]][["main"]]), digits = 0)
...
print("Summary uncertainty estimates (extern uncertainty function): ")
round(as.numeric(bestcost_noise_ihd_expDist_extern_uncertainty[["detailed"]][["uncertainty"]][["main"]]), digits = 0)
# Results seem plausible
```
...
round(as.numeric(bestcost_noise_ihd_expDist_iteration[["detailed"]][["raw"]] |> filter(erf_ci == "central") |> filter(exp_ci == "central") |> pull(impact_rounded)), digits = 0) 
## Summary uncertainty estimates from include_summary_uncertainty()
round(as.numeric(bestcost_noise_ihd_expDist_iteration_uncertainty[["detailed"]][["uncertainty"]][["raw"]]$impact_central), digits = 0)
# Results are higher due to difference in PAF of categories 2 & 3

# Check aggregated impact
print("Main estimate: ") ; bestcost_noise_ihd_expDist_iteration[["main"]][["impact_rounded"]]
print("Summary uncertainty estimates (extern uncertainty function): ")
round(as.numeric(bestcost_noise_ihd_expDist_iteration_uncertainty[["detailed"]][["uncertainty"]][["main"]] |> pull(central_estimate)), digits = 0)
...
round(as.numeric(bestcost_pm_yld_singlebhd_with_summary_uncertainty[["detailed"]][["uncertainty"]][["intern"]]), digits = 0)
print("Summary uncertainty estimates (external function): ")
round(as.numeric(bestcost_pm_yld_singlebhd_external_summary_uncertainty[["detailed"]][["uncertainty"]][["main"]]), digits = 0)
# Results seem plausible
```
...
# Internal uncertainty function
print("Summary uncertainty central estimate (internal function): ")
round(as.numeric(bestcost_noise_ha_ar_with_summary_uncertainty[["detailed"]][["uncertainty"]][["intern"]]), digits = 0)
# External include_summary_uncertainty function
print("Summary uncertainty estimates (extern uncertainty function): ")
round(as.numeric(bestcost_noise_ha_ar_external_uncertainty[["detailed"]][["uncertainty"]][["main"]]), digits = 0)
# Results seem plausible
```
...
# Comparison central +- 95% CIs & Monte-Carlo central, lower, upper estimates
# View(bestcost_pm_yld_singlebhd_with_summary_uncertainty)
print("Main estimates: ") ; bestcost_noise_ha_ar_iteration_with_summary_uncertainty[["main"]][["impact_rounded"]]
print("Summary uncertainty estimates (external function): ")
round(as.numeric(bestcost_noise_ha_ar_iteration_with_summary_uncertainty[["detailed"]][["uncertainty"]][["main"]]), digits = 0)
# Results seem plausible
```
...
round(as.numeric(bestcost_pm_deaths_lifetable_airqplus_with_summary_uncertainty[["detailed"]][["uncertainty"]][["intern"]] |> filter(sex == "total") |> select(-sex)), digits = 0)
# Results seem plausible
```
