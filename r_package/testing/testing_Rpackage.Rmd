...
```{r impact exposure distribution}

impact_expDistribution_raw <- list()


for(i in 1:nrow(input_data_morbidities)){
  impact_expDistribution_raw[[input_data_morbidities$year[i]]][[input_data_morbidities$crf_id[[i]]]] <-
