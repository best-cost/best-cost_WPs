...
```{r Social aspects in a simple case, eval=FALSE, include=FALSE}
# Take into account social aspects
bestcost_pm_copd_geo_social <- 
  healthiar::include_social(output = bestcost_pm_copd_geo,
                           geo_id_raw = 1:1E4,
                           deprivation_weight = as.list(runif_with_seed(1E4, 0.5, 0.8, 1)))
```
