...
```{r premature deaths with lifetable geluft input}
...
```{r yll from SINGLE YEAR EXPOSURE from lifetable airqplus approach}
...
# View(bestcost_pm_yll_lifetable_geluft)

# Comparison premature-deaths in year of analysis
deaths_yoa <- tibble(
  deaths_yoa_airqplus = bestcost_pm_yll_exposure_single_year_lifetable_airqplus[["detailed"]][["interim"]][["premature_deaths_nest"]][[3]]$population_2019,
  deaths_yoa_geluft = bestcost_pm_yll_lifetable_geluft[["detailed"]][["interim"]][["pop_impact_nest"]][[3]]$population_2020
  )
sum(deaths_yoa$deaths_yoa_airqplus[21:100])
sum(deaths_yoa$deaths_yoa_geluft[21:100])
# airqplus ca. 6.5 % lower than geluft


# Comparison total YLL GeLuft & AirQ+
yll_yoa <- tibble(
  yll_yoa_airqplus = bestcost_pm_yll_exposure_single_year_lifetable_airqplus[["detailed"]][["interim"]][["lifeyears_nest"]][[3]]$impact[2:100],
  yll_yoa_geluft = bestcost_pm_yll_lifetable_geluft[["detailed"]][["interim"]][["lifeyears_nest"]][[3]]$impact
)
sum(yll_yoa$yll_yoa_airqplus)
sum(yll_yoa$yll_yoa_geluft)
# airqplus ca. 10% higher than geluft
```


```{r yll FROM CONSTANT EXPOSURE from lifetable airqplus approach}
...
yll_total_unrouned <- bestcost_pm_yll_lifetable_airqplus[["detailed"]][["interim"]][["pop_impact_nest"]][[3]] %>% select(-age_end)
...
test <- tibble(airqplus_yll = airqplus_yll_difference$`2020`,
               bestcost_yll = yll_total_rounded$population_2020)
