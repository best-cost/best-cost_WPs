...
devtools::build(path = "../") # Save current state of package as tar.gz file (e.g. to directly test changes in functions)
...
```{r Summary uncertainty rr attribute_yld_from_prevalence }
