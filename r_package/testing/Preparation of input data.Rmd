...
airqplus_morb <- 
  ...
  # Add rows of results
  dplyr::bind_rows(airqplus_morb_output)%>%
  ...
  tidyr::pivot_wider(names_from = variable, 
                     values_from = value)%>%
  # Convert to numeric
  dplyr::mutate(across(-c(analysis_name, type, pollutant, location,analyis_comment, evaluation_type, evaluation_name, health_endpoint), as.numeric))
