...
check_bestcost <-
  ...
  result_vector_bestcost <- 
    ...
    # Set order of rows
    dplyr::arrange(factor(rr_ci, levels = c("central", "lower", "upper")))%>%
...
airqplus_deaths_pop_multipleYear <-
  read.csv2("../testing/input/data/life_tables/airqplus_manual_age0to14_multipleYear.csv")
airqplus_deaths_pop_singleYear <-
  read.csv2("../testing/input/data/life_tables/airqplus_manual_age0to14_singleYear.csv")
```
...
airqplus_copd_export <-
  # Read csv file
  readr::read_delim("../testing/input/airqplus_cases/GeLuft_GeLuft_COPD.csv",
                    delim = ";",
                    col_types = cols())
...
```
```{r Read asssessment for noise}

# The assessment for noise was provided by NIPH
airqplus_morb_export <-
  # Read csv file
  readr::read_delim("../testing/input/noise_niph/example_daly_noise_niph.xlsx",
                    delim = ";",
                    col_types = cols())
